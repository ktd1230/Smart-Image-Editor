  ...
  <div>
    <v-container fluid pa-0>
      <v-row>
        ...
        data-aos="fade-up"
        data-aos-duration="2000"
        data-aos-delay="50">Alpha Book</h1>
        <v-row>
        ...
        data-aos="fade-up"
        data-aos-duration="2000"
        data-aos-delay="2000">Make Your Story</h2>
        <div class="m-5 p-5"
        data-aos="fade-up"
        data-aos-duration="2000"
        data-aos-delay="2000">
          <v-btn rounded x-large style="background-color:#EB539E;padding-left:90px;padding-right:90px;" dark @click="openDialog(true)"> 바로 시작하기 </v-btn>
        </div>
      </v-col>
              <v-col></v-col>
            </v-row>
      ...
      <v-layout column wrap align-center>
        <v-flex xs12 sm4 class="my-4">
          <div class="text-center">
            ...
            data-aos-duration="1500"
            data-aos-delay="50" 
            style="color:#FF80AB; font-size:40px; font-weight:bold; font-family:noto sans kr; display: inline-block">드래그&드롭</h3>
            <h3 data-aos="fade-left"
            data-aos-duration="1500"
            data-aos-delay="50"
            style="font-size:35px; font-family:noto sans kr; font-weight:bold; display: inline-block">으로 누구나 쉽게</h3>
            <h2  class="headline" 
            data-aos="fade-left"
            data-aos-duration="1500"
            data-aos-delay="250"  style="font-size:30px; font-family:noto sans kr;">이야기를 만들 수 있습니다.</h2>
            <br/>
            <p class="subheading"
            data-aos="fade-right"
            data-aos-duration="2000"
            ...
            ><strong>표현력</strong>이 부족해도, <strong>글재주</strong>가 없어도 괜찮습니다.<br/>
            원하시는 <strong>사진</strong>을 올리시면, 당신만의 <strong>이야기</strong>를 만들어 드립니다.</p>
          </div>
        </v-flex>
          ...
          <v-container grid-list-xl>
            <v-layout row wrap align-center>
              <v-flex xs12 md4>
                <v-card flat class="transparent">
                  <v-card-text class="text-center">
                    <v-icon x-large class="blue--text text--lighten-2">mdi-broom</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline text-center" 
                  data-aos="fade-right"
                  data-aos-duration="1500"
                  data-aos-delay="50">Service</div>
                  </v-card-title>
              ...
              <v-flex xs12 md4>
                <v-card flat class="transparent">
                  <v-card-text class="text-center">
                    <v-icon x-large class="blue--text text--lighten-2">mdi-home-outline</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline"
                    data-aos="fade-down"
              ...
              <v-flex xs12 md4>
                <v-card flat class="transparent">
                  <v-card-text class="text-center">
                    <v-icon x-large class="blue--text text--lighten-2">mdi-handshake</v-icon>
                  </v-card-text>
                  <v-card-title primary-title class="layout justify-center">
                    <div class="headline text-center"
                    data-aos="fade-left"
